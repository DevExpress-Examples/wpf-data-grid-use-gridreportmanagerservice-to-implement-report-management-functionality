...
Namespace ReportManagerServiceExample.ViewModels
	...
	Public Class MainViewModel
		...
		Public Sub New()
			...
			Employees.Add(ViewModelSource.Create(Function() New EmployeeViewModel() With {
				.Name = "Frankie West PhD",
				.Department = "Music",
				.EmployeeID = 0
			}))
			Employees.Add(ViewModelSource.Create(Function() New EmployeeViewModel() With {
			...
			Employees.Add(ViewModelSource.Create(Function() New EmployeeViewModel() With {
				.Name = "Jefferey Legros III",
				.Department = "Management",
				.EmployeeID = 7
			}))
			Employees.Add(ViewModelSource.Create(Function() New EmployeeViewModel() With {
				.Name = "Margaretta Roberts",
				.Department = "Management",
				.EmployeeID = 8
			}))
		End Sub
